                    ...
                    <form class="auth-form" on:submit|preventDefault={registerUser}>
                        ...
                        <div class="form-field">
                            ...
                            <div class="input-ctn">
                                ...
                                <input type="email" bind:value="{email}" name="email" id="email" placeholder="Type your email address" spellcheck="false" autocomplete="off" autocapitalize="off" autofocus>
                            </div>
                        </div>
                        <div class="form-field">
